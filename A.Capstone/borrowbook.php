...
<body>
    ...
    <div class="book-details-container">
      ...
      <div class="book-details">
        ...
        <div class="book-meta">
          ...
          <button class="borrow-button" onclick="showBorrowNotice()">Borrow</button>
        </div>
      </div>
    </div>
    <div class="overview">
  ...
  <div id="borrow-notice" class="notice-popup">
    <div class="notice-content">
      <p>Great! The book, "Leadership and Revolution" by Lori Mazan you requested for borrowing is being processed by the librarian. Please visit the library before 7 PM to pick up your book.</p>
      <button class="confirm-button">Confirm</button>
      <button class="cancel-button" onclick="hideBorrowNotice()">Cancel</button>
    </div>
  </div>

  <script>
    function showBorrowNotice() {
      document.getElementById('borrow-notice').style.display = 'block';
    }

    function hideBorrowNotice() {
      document.getElementById('borrow-notice').style.display = 'none';
    }
  </script>
</body>
</html>
